...
import net.sf.anathema.character.library.trait.IBoostableTrait;
import net.sf.anathema.character.library.trait.IModifiableCapTrait;
import net.sf.anathema.character.library.trait.IModifiableGenericTrait;
import net.sf.anathema.character.library.trait.ITrait;
import net.sf.anathema.lib.control.change.IChangeListener;

public interface IDefaultTrait extends ITrait, IModifiableBasicTrait, IModifiableGenericTrait, IModifiableCapTrait, IBoostableTrait {
